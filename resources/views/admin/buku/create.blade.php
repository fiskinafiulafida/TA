				...
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<div class="form-wrap">
                                <form action="/bukuAdmin" method="POST" enctype="multipart/form-data">
                                    @csrf
									<div class="form-body">
										<h6 class="txt-dark capitalize-font"><i class="fa fa-credit-card-alt"></i> Form Tambah Data Buku</h6>
											...
											<div class="col-md-12 ">
                                                ...
                                                <div class="form-group">
													...
													<select class="form-control" id="ketersediaan" name="ketersediaan">
                                                        @foreach ($ketersediaan as $ter)
                                                            <option value="{{ $ter->ketersediaan}}">{{ $ter->deskripsi }}</option>
                                                        @endforeach
													</select> 
												</div>
                                                <div class="form-group">
