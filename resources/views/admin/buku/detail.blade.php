				...
				<div class="col-md-12">
					<div class="form-wrap">
						<form class="form-horizontal" role="form">
							<div class="form-body">
								<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Detail Buku</h6>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-9">
												<p class="form-control-static"> {{$show->penerbit}} </p>
											</div>
										</div>
									</div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-3"> Id Ketersediaan : </label>
											<div class="col-md-9">
												<p class="form-control-static"> {{$show->ketersediaan}} </p>
											</div>
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-3"> Cover Buku : </label>
											<div class="col-md-9">
                                                <img width="150px" src="{{asset('image/'.$show-> cover_img)}}">
											</div>
										</div>
									</div>
								</div>
