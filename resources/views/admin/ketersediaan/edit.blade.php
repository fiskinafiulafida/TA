				...
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<div class="form-wrap">
                                <form action="{{ route('ketersediaanAdmin.update', $edit->ketersediaan) }}" method="POST">
                                    @csrf
                                    @method('PUT')
									<div class="form-body">
										<h6 class="txt-dark capitalize-font"><i class="fa fa-credit-card-alt"></i> FROM EDIT KETERSEDIAAN</h6>
										<hr class="light-grey-hr"/>
										<div class="row">
											<div class="col-md-12 ">
                                                <div class="form-group">
													<label class="control-label mb-10 text-left">Deskripsi Ketersediaan</label>
									...
									<div class="form-actions mt-10">
                                        ...
                                        <a class="btn  btn-primary btn-rounded" href="{{ route ('ketersediaanAdmin.index') }}">Cancel</a>
									</div>
								</form>
							</div>
						</div>
