...
@section('title','Halaman Detail Ketersediaan')
@section('nav')
				...
				<div class="col-md-12">
					<div class="form-wrap">
						<form class="form-horizontal" role="form">
							<div class="form-body">
								<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Detail Ketersediaan Buku</h6>
								<hr class="light-grey-hr"/>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-3"> Ketersediaan : </label>
											<div class="col-md-9">
