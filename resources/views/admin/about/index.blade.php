...
@section('title','Halaman About Admin')
@section('nav')
    ...
    <div class="container-fluid">		
		...
		<div class="row heading-bg">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			  <h5 class="txt-dark">Data About</h5>
			</div>
			<!-- Breadcrumb -->
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="panel panel-default card-view">
					<td>
						<a class="btn  btn-primary btn-rounded" href="{{ route ('aboutAdmin.create') }}">Tambah Data</a>
					</td>
									...
									<table id="datable_1" class="table table-hover display" >
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<form action="{{ route('aboutAdmin.destroy', $about->id) }}" method="POST">
													    <a href="{{ route('aboutAdmin.show',$about->id) }}" class="btn  btn-success btn-rounded">Detail</a>
													    <a href="{{ route('aboutAdmin.edit',$about->id) }}" class="btn btn-warning btn-rounded">Edit</a>
													    @csrf
                    								    @method('DELETE')
