...
@section('title','Halaman Edit About ')
@section('nav')
...
@section('navright')
   	<ul class="nav navbar-nav side-nav nicescroll-bar">
		...
		<li>
    		<a href="{{ route('aboutMember.index') }}"><div class="pull-left"><i class="fa fa-wpforms mr-20"></i><span class="right-nav-text">About</span></div><div class="clearfix"></div></a>
    	</li><li>
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<div class="form-wrap">
                                <form action="{{ route('aboutAdmin.update', $edit->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
									<div class="form-body">
										<h6 class="txt-dark capitalize-font"><i class="fa fa-credit-card-alt"></i> FROM EDIT ABOUT</h6>
										<hr class="light-grey-hr"/>
										<div class="row">
											<div class="col-md-12 ">
												<div class="form-group">
													<label class="control-label mb-5">Judul About : </label>
													<input type="text" name="judul" value="{{ $edit->judul }}" class="form-control">
												</div>
                                                <div class="form-group">
													<label class="control-label mb-10 text-left">Deskripsi About</label>
													<!-- <textarea class="form-control" name="deskripsi" value="{{ $edit->deskripsi }}" rows="5"></textarea> -->
													<input type="text" name="deskripsi" value="{{ $edit->deskripsi }}" class="form-control">
												</div>
											</div>
										</div>
									</div>
									<div class="form-actions mt-10">
                                        ...
                                        <a class="btn  btn-primary btn-rounded" href="{{ route ('aboutAdmin.index') }}">Cancel</a>
									</div>
								</form>
							</div>
						</div>
