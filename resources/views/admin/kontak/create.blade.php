...
@section('title','Halaman Tambah Kontak')
@section('nav')
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<div class="form-wrap">
								<form method="POST" action="{{ route ('kontakAdmin.store')}}">
                                    @csrf
									<div class="form-body">
										<h6 class="txt-dark capitalize-font"><i class="fa fa-credit-card-alt"></i> Form Tambah Kontak</h6>
										...
										<div class="row">
											<div class="col-md-12 ">
                                                ...
                                                <div class="form-group">
													<label class="control-label mb-5">Alamat : </label>
													<input type="text" name="alamat" class="form-control">
												</div>
                                                <div class="form-group">
													<label class="control-label mb-5">No Telephone : </label>
