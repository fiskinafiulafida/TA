				...
				<div class="col-md-12">
					<div class="form-wrap">
						<form class="form-horizontal" role="form">
							<div class="form-body">
								<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Detail Kategori Buku</h6>
								<hr class="light-grey-hr"/>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-3">ID Kategori Buku :</label>
											<div class="col-md-9">
												<p class="form-control-static"> {{$kategori->kategori}} </p>
											</div>
										</div>
									</div>
									<div class="col-md-6">
